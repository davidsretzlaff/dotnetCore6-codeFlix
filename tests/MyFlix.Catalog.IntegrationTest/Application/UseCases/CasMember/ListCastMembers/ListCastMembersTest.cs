...
namespace MyFlix.Catalog.IntegrationTest.Application.UseCases.CasMember.ListCastMembers
{
	...
	public class ListCastMembersTest
	{
		...
		public async Task SearchByText(string search, int page, int perPage, int expectedQuantityItemsReturned, int expectedQuantityTotalItems)
		{
			...
			{
				"Action", "Horror", "Horror - Robots", "Horror - Based on Real Facts", "Drama",
				"Sci-fi IA", "Sci-fi Space", "Sci-fi Robots", "Sci-fi Future"
			};
